...
export function printThermalReceipt({
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; -webkit-print-color-adjust:exact; print-color-adjust:exact; }
    ...
    <div class="divider"></div>
    <table>
      ${subtotal != null ? `<tr><td>Subtotal</td><td class="qty"></td><td class="amt">Rs. ${subtotal}</td></tr>` : ""}
      ${discount > 0 ? `<tr><td>Discount</td><td class="qty"></td><td class="amt">-Rs. ${discount}</td></tr>` : ""}
      ${tax > 0 ? `<tr><td>Tax</td><td class="qty"></td><td class="amt">Rs. ${tax}</td></tr>` : ""}
      <tr class="total"><td>TOTAL</td><td class="qty"></td><td class="amt">Rs. ${total}</td></tr>
    </table>
    <div class="divider"></div>
